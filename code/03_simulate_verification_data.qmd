...
MOWI_farms <- filter(read_csv(glue("{proj_dir}/data/se_permit_conditions.csv")), 
                     grepl("Mowi", operator))$sepaSiteId |> unique()
...
```{r}
#| label: "pen_df"
pen_df <- read_csv(glue("{inputs_dir}/pen_sites_widerLinnhe_2023-2025.csv"), 
                   show_col_types=F) |>
...
```{r}
#| label: "farm_i"
farm_i <- read_csv(glue("{inputs_dir}/farm_sites_widerLinnhe_2023-2025.csv"),
                   show_col_types=F) |>
