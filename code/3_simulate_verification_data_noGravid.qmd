...
ggplot(attach_df, aes(RW, plogis(eta), colour=uv)) + geom_point() + ylim(0, 1) + geom_abline()
...
p_prSurv <- expand_grid(
  ...
  mutate(pr_surv=plogis(params$surv_beta[1,stage] +
         ...
         stage=factor(stage, 
                      labels=c("chal", "pread", "adult", "gravid")[1:info$nStages])) |>
