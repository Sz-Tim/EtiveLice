...
p_prAttachIP <- expand_grid(
  IP=seq(0, 10, by=0.1)*max(info$IP_penVolume),
  ...
  geom_raster() +
  annotate("text", x=0.5, y=0.85, parse=T, hjust=0, vjust=0, size=3,
           label=paste0("IP[bg]:~", round(params$IP_bg_m3, 3), "~cop~m^-3~h^-1")) +
  annotate("text", x=0.5, y=0.75, parse=T, hjust=0, vjust=0, size=3,
